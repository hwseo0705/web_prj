...
public class BoardRepositoryImpl implements BoardRepository {
    ...
    public List<Board> findAll(Page page) {
        ...
        /*
        *   만약에 1페이지를 보고 싶고 10개씩 보고 싶으면 --> BETWEEN 1 AND 10
        *   만약에 2페이지를 보고 싶고 10개씩 보고 싶으면 --> BETWEEN 11 AND 10
        *
        *   만약에 1페이지를 보고 싶고 20개씩 보고 싶으면 --> BETWEEN 1 AND 20
         *  만약에 2페이지를 보고 싶고 10개씩 보고 싶으면 --> BETWEEN 21 AND 40
         *
